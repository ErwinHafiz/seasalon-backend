...
export interface ApiComentarComentar extends Schema.CollectionType {
  collectionName: 'comentars';
  info: {
    singularName: 'comentar';
    pluralName: 'comentars';
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    duration: Attribute.Integer;
    service_times: Attribute.Relation<
      'api::service.service',
      'manyToMany',
      'api::service-time.service-time'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiServiceTimeServiceTime extends Schema.CollectionType {
  collectionName: 'service_times';
  info: {
    singularName: 'service-time';
    pluralName: 'service-times';
    displayName: 'Service_time';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::comentar.comentar': ApiComentarComentar;
      'api::contact.contact': ApiContactContact;
      'api::customer.customer': ApiCustomerCustomer;
      'api::doctor.doctor': ApiDoctorDoctor;
      'api::reservation.reservation': ApiReservationReservation;
      'api::service.service': ApiServiceService;
      'api::service-time.service-time': ApiServiceTimeServiceTime;
